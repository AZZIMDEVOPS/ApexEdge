...
const ADVISORY_PILLARS: PillarArchitecture[] = [
  {
    ...
    purpose: "Transforms board reporting from hundreds of pages of raw paper data into eBoard Frameworks, paperless governance portals, prioritized risk heat maps, and clear decision papers.",
    ...
    mechanism: "Independent governance audits, eBoard Frameworks for paperless digital board meetings, CMA & Companies Act 2015 alignment, Board charter revisions, and delegated authorization limits.",
    deliverables: [
      ...
      "Independent CMA & Governance Evaluation Audits",
    ],
    interconnectivity: "Informs People & Performance mandates (Pillar 02) and internal control limits (Pillar 03).",
    statutoryStandard: "CMA Corporate Governance Guidelines, Kenyan Companies Act 2015, CBK Prudential Guidelines",
  },
  {
    id: "people",
    num: "02",
    shortTitle: "People & Performance",
    title: "PEOPLE, PERFORMANCE & LEADERSHIP ARCHITECTURE",
    tagline: "Role Clarity, Salary Grading, Leadership Velocity & OKRs",
    icon: Users,
    color: "#059669",
    ...
    purpose: "Bridges the gap between organizational strategy and individual accountability through structured job grading, executive decision toolkits, transparent salary bands, and strategy-aligned OKR scorecards.",
    breakpointSolved: "High executive payroll without proportional output, role overlap, fuzzy ownership, capability gaps, and strategic plans stalled in slide decks.",
    mechanism: "Paterson/PwC-standard job evaluation, transparent salary structure design, cascade OKR mapping, 90-day execution sprints, and single-point RACI accountability matrices.",
    deliverables: [
      "Executive Decision-Making & Leadership Capability Toolkits",
      "90-Day Tactical Execution Roadmaps & Sprints",
      "Recruitment Processes & Candidate Search Workflows",
      "Job Grading & Salary Band HR Frameworks",
      "Single-Point RACI Accountability Frameworks",
      "Competency & Job Description HR Frameworks",
      "Strategy-Aligned OKR & KPI Scorecard Frameworks",
      "Employment Statutory HR Compliance Frameworks",
    ],
    interconnectivity: "Translates Board mandates (Pillar 01) into everyday management routines enforced by Controls (Pillar 03).",
    statutoryStandard: "Employment Act (Kenya), International Job Evaluation Benchmarks, Executive Leadership Governance",
  },
  {
    id: "controls",
    num: "03",
    ...
    interconnectivity: "Operationalizes governance policies (Pillar 01) and gives employees clear execution boundaries (Pillar 02).",
  ...
  },
  {
    ...
    deliverables: [
      "ODPC Data Controller & Data Processor Statutory Registration Certificates",
  ...
  },
  {
    ...
    deliverables: [
      "1. Beneficial Ownership Filings & BRS Disclosures",
      "2. Registration & Maintenance (BRS Annual Returns)",
      "3. Secretarial Services (Board Resolutions & AGM/EGM Minutes)",
      "4. Company Record Management & Statutory Registers",
    ],
    interconnectivity: "Supports Board Governance (Pillar 01) and ensures statutory validity across all Control (Pillar 02) and Data Protection (Pillar 04) frameworks.",
